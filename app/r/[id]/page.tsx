...
const ReportPage = () => {
    ...
    const fetchReport = async () => {
      ...
      try {
        ...
        if (data && data.report_data) {
          ...
          const items = reportData.feedback_items || reportData.feedback || reportData.categorized_items || [];
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text(`Overall Summary: ${report.overall_summary}`, 14, 32);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-6">
                <div>
                  ...
                  <p className="text-lg text-gray-400 mb-6">{report.overall_summary}</p>
                </div>
                <div className="space-y-4">
